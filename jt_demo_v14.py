...
def copy_button_js(text_to_copy: str, button_text: str = "Copy to Clipboard", key_suffix=""):
    ...
    # The HTML component with a hidden textarea and a button
...
# =========================
    ...
    * **Pattern C: Skeptical but open...** (Topic-y, not yet a story)
    ...
    with col1:
        ...
        st.text_area("Prompt Text", final_prompt, height=450, label_visibility="collapsed", key="main_prompt_text_area")
    ...
    with col2:
        ...
        - **2. Context:** Injects the details you provided.
        - **3. Editorial Framework:** Gives the AI a checklist to model how an editor thinks.
        - **4. Conversational Flow:** Dictates the **process** to ensure the conversation is productive.
        - **5. Core Constraints:** The guardrails that reinforce the coaching goal.
        """)
        if st.button("Just copy it", use_container_width=True):
            # This is a bit of a hack for Streamlit's rerun behavior
