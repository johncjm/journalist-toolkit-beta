...
if st.session_state.page == 'portal':
    ...
    # TODO: Add more explanatory text here about the JT process.
    st.markdown("---")
...
# --- Page 3: The Prompt Recipe ---
    ...
    # --- FIX: Corrected and strengthened logic for selecting instructions ---
    response_mode = data.get('response_mode', 'dialogue')
    ...
    st.components.v1.html(
        ...
        function copyToClipboard() {{
            const text = `{final_prompt.replace("`", "\\`")}`;
